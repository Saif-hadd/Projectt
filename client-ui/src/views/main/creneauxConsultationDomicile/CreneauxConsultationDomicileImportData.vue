    ...
    <el-form :model="form" :rules="rules" ref="ruleFormRef">
      ...
      <div class="form_items">
        ...
        >
          <el-select
            v-model="form[field]"
            :data-test="`creneauxconsultationdomicileImportData_${field}`"
          >
            <el-option
      ...
      <div class="d-flex justify-content-end">
        <el-button
          data-test="creneauxconsultationdomicileImportDataFormCancelButton"
          @click="resetForm(ruleFormRef)"
          >Clear</el-button
        >
        <el-button
          data-test="creneauxconsultationdomicileImportDataFormSubmitButton"
          type="primary"
...
const { error } = storeToRefs(useCreneauxConsultationDomicileStore());
const {
  createManyCreneauxConsultationDomicile,
...
const creneauxconsultationdomicileInsertData: any = ref([]);
...
const handelUploadFile: UploadProps["onChange"] = (rawFile: any) => {
  if (rawFile) {
    ...
    reader.onload = (e) => {
      ...
      creneauxconsultationdomicileInsertData.value = jsonData;
    };
...
const onSubmit = (formEl: InstanceType<typeof ElForm> | undefined) => {
  ...
  formEl.validate(async (valid) => {
    ...
    if (valid && !isEqual(initialState, rest)) {
      creneauxconsultationdomicileInsertData.value = creneauxconsultationdomicileInsertData.value.map(
        (item: any) => {
          let res: any = {};
          for (let key in rest) {
      ...
      await createManyCreneauxConsultationDomicile(
        creneauxconsultationdomicileInsertData.value
      );
