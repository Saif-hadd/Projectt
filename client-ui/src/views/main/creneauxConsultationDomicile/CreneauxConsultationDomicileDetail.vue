  ...
  <el-row>
    <el-col :xs="24" :md="12" class="mx-auto mb-4">
      <el-card :body-style="{ padding: '0px' }">
        ...
        <div style="padding: 14px" v-if="creneauxconsultationdomicile">
          <el-row
            :gutter="10"
          ...
          <div class="bottom">
            <el-button
              :data-test="creneauxconsultationdomicileDetailBackBtn"
              type="primary"
              @click="() => $router.go(-1)"
              icon="ArrowLeft"
...
const { creneauxconsultationdomicile } = storeToRefs(
...
onMounted(async () => {
  ...
  setCurrentPageBreadcrumbs("creneauxconsultationdomiciles", ["detail"]);
});
</script>
<style>
.bottom {
