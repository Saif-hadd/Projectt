...
@InputType()
class CreneauxConsultationDomicileWhereInput {
  @ApiProperty({
    required: false,
    type: StringFilter,
  })
  ...
  heureDebut?: DateTimeNullableFilter;
  ...
  heureFin?: DateTimeNullableFilter;
...
export { CreneauxConsultationDomicileWhereInput };
